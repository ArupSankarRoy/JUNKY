...
# Experiment of Loggoing
# logging.info('Welcome to my custom log')

# Experiment of exception
#try:
#    val = 10/0
#    print(val)
...
def predictRoute():
    try:
        ...
        opencodedbase64 = encodeImageIntoBase64("yolov5/runs/detect/exp/inputImage.jpg") # exp realtime means each time running the code a new exp folder created
